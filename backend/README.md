...
## Project Structure
    ...
    ├── testapiautostoryboa_98458  # Django project configurations
...
1. Clone this repo and `cd testapiautostoryboa_98458`
...
2. Clone this repo and `cd testapiautostoryboa_98458`
